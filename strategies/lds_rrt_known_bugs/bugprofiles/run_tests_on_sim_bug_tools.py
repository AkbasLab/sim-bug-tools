...
class RunTestsOnSimulators(unittest.TestCase):

    def simulator_known_bugs(self, i : int):
    ...
    def simulator_known_bugs_faure_sequence(self, i : int):
        with open(UNITTEST_DIR + "/test_bug_profiles/test_bugs" + str(i) + ".json", "r") as f:
            for line in f:
                hhh = json.loads(line)
                break
    ...
    def simulator_known_bugs_halton_sequence(self, i : int):
        with open(UNITTEST_DIR +"/test_bug_profiles/test_bugs" + str(i) + ".json", "r") as f:
            for line in f:
                hhh = json.loads(line)
                break
    ...
    def simulator_known_bugs_sobol_sequence(self, i : int):
        with open(UNITTEST_DIR + "/test_bug_profiles/test_bugs" + str(i) + ".json", "r") as f:
            for line in f:
                hhh = json.loads(line)
                break
    ...
    def simulator_known_bugs_lattice_sequence(self, i : int):
        with open(UNITTEST_DIR + "/test_bug_profiles/test_bugs" + str(i) + ".json", "r") as f:
            for line in f:
                hhh = json.loads(line)
                break
    ...
    def simulator_known_bugs_rrt(self, i : int):
    ...
    def generate_bug_profile(self, n_dim : int, n_clusters : int, i : int):
    ...
    def test_all_cluster_dimension_combiniation(self):
        ...
        for dimension in dimension_range:
            for cluster in cluster_range:
                self.generate_bug_profile(dimension,cluster,i)
                self.simulator_known_bugs(i)
                self.simulator_known_bugs_faure_sequence(i)
                self.simulator_known_bugs_lattice_sequence(i)
                self.simulator_known_bugs_halton_sequence(i)
                self.simulator_known_bugs_rrt(i)
                self.simulator_known_bugs_sobol_sequence(i)
                i = i + 1
