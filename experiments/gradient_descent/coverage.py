...
for nd in ndims:
    ...
    expl_params = ExplorationParams(f"brrt-{e_type}-{adh_type}-{nd}d-{seed}", expl, 500)
    ...
    ## Ground truth
    ground_truth_scored_matrix = utils.brute_force_grid_search(envelope, domain, grid)
    ...
    boundary = utils.true_boundary_algorithm(ground_truth_class_matrix, envelopes[0])
